...
# Load your dataset
df = pd.read_csv('cobol_java_pairs_preprocessed2.csv')
...
st.markdown("""
Convert your COBOL code to Java with ease! Simply enter your COBOL code in the text area below and click the **Convert** button.
""")

# Create a sidebar for instructions
st.sidebar.title("Instructions")
st.sidebar.markdown("""
1. Enter your COBOL code in the text area.
2. Click the **Convert** button.
3. The converted Java code will be displayed below.
""")

# Add background color and set text color
st.markdown(
    """
    <style>
...
# Create a text area for entering COBOL code with increased size
cobol_code = st.text_area("Enter your COBOL code here:", height=400)

# Create a button to trigger conversion
if st.button("Convert"):
    java_code = generate_java_code_from_cobol(cobol_code)
    st.text_area("Converted Java code:", value=java_code, height=600)  # Set the height parameter to increase the output textbox size
